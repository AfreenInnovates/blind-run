import { KEYCARD_POSITION, KEYPAD_POSITION } from "../../packages/sim/src/layout";
...
export const MARKERS: MarkerDef[] = [
  /* --- security room ------------------------------------------------ */
  {
    ...
    room: "sec",
    color: C.yellow,
    position: [KEYCARD_POSITION.x, 0.95, KEYCARD_POSITION.z],
    labelOffset: [0, 0.7, 0],
  },
  {
    id: "health",
  ...
  /* --- vault room --------------------------------------------------- */
  {
    ...
    room: "vault",
    color: C.yellow,
    position: [KEYPAD_POSITION.x, 1.6, KEYPAD_POSITION.z],
