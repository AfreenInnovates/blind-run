...
//#region C:/Users/ADMIN/Desktop/Afreen/moonshot2/moonshot/spacetime/node_modules/headers-polyfill/lib/index.mjs
...
//#endregion
//#region C:/Users/ADMIN/Desktop/Afreen/moonshot2/moonshot/spacetime/node_modules/spacetimedb/dist/server/index.mjs
...
//#endregion
//#region C:/Users/ADMIN/Desktop/Afreen/moonshot2/moonshot/spacetime/src/index.ts
/**
...
const join_room = spacetimedb.reducer({ code: t.string() }, (ctx, { code }) => {
	...
	if (room.phase === "lobby" && seats + 1 >= room.max_players) ctx.db.game_room.code.update({
		...room,
...
function drawRoles(ctx, code, allowEarly) {
	const room = ctx.db.game_room.code.find(code);
...
const draw_roles = spacetimedb.reducer({ code: t.string() }, (ctx, { code }) => drawRoles(ctx, code, false));
